...
export default function EditSidebar() {
  ...
  return (
    <>
      ...
      <div
        className={`edit-sidebar absolute bottom-0 right-0 top-0 z-40 flex w-3/4 transform flex-col justify-between rounded-l-md border border-gray-300 bg-sidebar-main text-sm font-light text-black shadow-2xl transition-transform duration-300 ease-in-out sm:max-w-72 md:max-w-80 ${
