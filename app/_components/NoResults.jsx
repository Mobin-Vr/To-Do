...
export default function NoResults({ query, bgColor }) {
  return (
    <div
      className="flex min-h-screen w-full max-w-xl flex-col items-center justify-center gap-4 p-10 text-center"
      style={{ backgroundColor: bgColor.mainBackground }}
    >
      <MenuBtn className="absolute left-5 top-5" bgColor={bgColor} />

      <h1 className="text-4xl font-thin" style={{ color: bgColor.primaryText }}>
        No results found !
      </h1>
